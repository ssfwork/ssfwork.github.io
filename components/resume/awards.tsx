          ...
          <div className="flex items-start mb-1">
            ...
            <div className="pl-20 space-y-1">
              ...
              <div className="text-sm text-justify text-slate-500 dark:text-slate-400">
                This recognition highlights my consistent contributions to the team, including offering innovative solutions, collaborating effectively with colleagues, and
                maintaining a strong focus on continuous improvement in both technical and communication skills.
              </div>
            </div>
          </div>
        </li>
        ...
        <li className="relative group">
          <div className="flex items-start mb-1">
            ...
            <div className="pl-20 space-y-1">
              ...
              <div className="text-sm text-justify text-slate-500 dark:text-slate-400">This recognition highlighted my self-learning ability and problem-solving skills.</div>
            </div>
          </div>
        </li>
      </ul>
