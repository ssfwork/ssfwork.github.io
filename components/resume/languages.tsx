      ...
      <ul className="space-y-3">
        <li className="flex justify-between items-center">
          <div className="grow inline-flex mr-1.5 truncate">
            <span className="text-base mr-1.5">ZH</span> <span className="font-aspekta font-[650] text-sm truncate">Chinese</span>
          </div>
          {/* <div
        ...
        <li className="flex justify-between items-center">
          <div className="grow inline-flex mr-1.5 truncate">
            <span className="text-base mr-1.5">EN</span> <span className="font-aspekta font-[650] text-sm truncate">English</span>
          </div>
          {/* <div
            className="shrink-0 relative w-5 h-5 rounded-full bg-[conic-gradient(theme(colors.sky.500)_70%,0,theme(colors.slate.200)_0)] dark:bg-[conic-gradient(theme(colors.sky.500)_100%,0,theme(colors.slate.700)_0)] after:absolute after:inset-0 after:rounded-full after:w-3 after:h-3 after:m-auto after:bg-white dark:after:bg-slate-800"
            role="progressbar"
            aria-valuenow={70}
            aria-valuemin={0}
            aria-valuemax={100}
